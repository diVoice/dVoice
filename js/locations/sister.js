$.extend(Locations.sister, {
	...
	load: function () {
		...
		lText = Game.getText('sister');
		/*Контроллер*/
		switch (dialogName) {
			case 'main':
				if (this.firstTimeStory < 10) {
					this.firstTimeStoryDialog();
				} else {
					this.main();
				}
				break;
	...
	firstTimeStoryDialog: function() {
		var imageFile = 'images/locations/sister/001.png';
		/**История первого посещения.*/
	...
	main: function () {
		...
		if (Master.control.getState() == 1) {
			imageFile = 'images/locations/sister/2_001.png';
		}
		if (Master.control.getState() == 2) {
			imageFile = 'images/locations/sister/3_001.png';
	...
	processDialogs: function() {
		...
		switch(currentDialogName) {
			case 'control':
				...
				ContentBlock.setImage('images/locations/sister/win_001.png');
				break;
			case 'superControl':
				if (win) {
					Master.control.increaseBy(10);
					var imageName = 'images/locations/sister/win_002.png';
					if (Master.control.getState() == 1) imageName = 'images/locations/sister/2_win_001.png';
					if (Master.control.getState() == 2) imageName = 'images/locations/sister/2_win_001.png';
					ContentBlock.setImage(imageName);
				} else {
					var imageName = 'images/locations/sister/loose_001.png';
					if (Master.control.getState() == 1) imageName = 'images/locations/sister/2_loose_001.png';
					if (Master.control.getState() == 2) imageName = 'images/locations/sister/2_win_001.png';
					ContentBlock.setImage(imageName);
					//ContentBlock.setImage('images/locations/sister/loose_001.png');
			...
			case 'Excitation':
				if (win) {
					...
					ContentBlock.setImage('images/locations/sister/001.png');
				} else {
					Master.control.decreaseBy(10);
					ContentBlock.setImage('images/locations/sister/win_002.png');
				}
				break;
			default : //main
		}
	...
	story: function() {
		...
		if (win) {
			...
			Master.control.increaseBy(5);
			ContentBlock.setImage('images/locations/sister/story/' + ('00' + (this.storyStep+1)).substr(-3) + '.png');
			...
			ContentBlock.setImage('images/locations/sister/story/loose_00' + (this.storyStep < 2 ? '1' : '2') + '.png');
